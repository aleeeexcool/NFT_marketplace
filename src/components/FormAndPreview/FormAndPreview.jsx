...
class FormAndPreview extends Component {
  ...
  callMintMyNFTFromApp = (e) => {
    ...
    this.props.mintMyNFT(
      ...
      this.state.cryptoBearName,
      this.state.cryptoBearPrice
    );
  };
      ...
      <div>
        <div className="card mt-1">
          <div className="card-body align-items-center d-flex justify-content-center">
            <h5>Color your crypto bear as you want it to be!</h5>
          </div>
        </div>
        <form onSubmit={this.callMintMyNFTFromApp} className="pt-4 mt-1">
          <div className="row">
            ...
            <div className="col-md-6 d-flex justify-content-center align-items-center">
              <CryptoBearNFTImage colors={this.state.userSelectedColors[0]} />
            </div>
          </div>
          <div className="row">
            <div className="col-md-3">
            ...
            <div className="col-md-6">
              <div className="form-group">
                <label htmlFor="cryptoBearName">Name</label>
                <input
                  required
                  type="text"
                  value={this.state.cryptoBearName}
                  className="form-control"
                  placeholder="Enter Your Crypto Bear's Name"
                  onChange={(e) =>
                    this.setState({ cryptoBearName: e.target.value })
                  }
                />
              </div>
              <div>
                ...
                <input
                  ...
                  name="price"
                  id="cryptoBearPrice"
                  value={this.state.cryptoBearPrice}
                  className="form-control"
                  placeholder="Enter Price In Ξ"
                  onChange={(e) =>
                    this.setState({ cryptoBearPrice: e.target.value })
                  }
                />
              </div>
              <button
